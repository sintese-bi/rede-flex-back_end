...
variableRouter.post("/name-station-table", checkToken, VariablesController.nameFuelStationTable)
...
variableRouter.post("/update-station-alert", checkToken, VariablesController.updateGasStationAlertsInfo)
